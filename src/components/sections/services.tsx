...
export function Services() {
  return (
    <section className="relative overflow-hidden bg-brand-green-darker text-white">
      ...
      <div className="relative z-10 mx-auto grid max-w-6xl gap-12 px-6 py-24 lg:grid-cols-2 lg:items-center">
        <div>
          <Reveal>
            <Eyebrow onDark>Our services</Eyebrow>
            <h2 className="mt-3 font-display text-3xl font-bold md:text-4xl">End-to-end irrigation services, handled by experts</h2>
