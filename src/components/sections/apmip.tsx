      ...
      <Container>
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <Reveal delay={240}>
              <ContactActions size="xl" waMessage={apmipMessage} className="mt-8" />
            </Reveal>
            <Reveal delay={320}>
              <div className="mt-6 flex flex-wrap items-center gap-4">
                <p className="text-sm text-water-deep/55">APMIP assistance for West Godavari and across Andhra Pradesh.</p>
                <Link href="/apmip-subsidy" className="tap-target-y inline-flex items-center gap-1.5 text-sm font-semibold text-brand-green transition-colors hover:text-water-deep">
          ...
          <Reveal delay={160}>
            <div className="sink-panel rounded-2xl p-6 md:p-8">
              <p className="flex items-center gap-2 text-sm font-semibold text-brand-green"><BadgeCheck className="h-4 w-4" /> How the subsidy process works</p>
