      ...
      <div className="relative z-10 mx-auto grid max-w-6xl gap-x-8 gap-y-10 px-6 py-14 md:grid-cols-12">
        ...
        <Reveal delay={240} className="md:col-span-2">
          ...
          <ul className="mt-4 space-y-1.5 text-sm">
            <li>
              <span className="block text-white/70">{siteConfig.hoursSummary.days}</span>
              {siteConfig.hoursSummary.time}
            </li>
            <li>
              <span className="block text-white/70">{siteConfig.hoursSummary.closedDay}</span>
              Closed
            </li>
          </ul>
        </Reveal>
