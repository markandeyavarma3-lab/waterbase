...
export function StickyCallBar() {
  return (
    <div className="sink-panel living-mesh-c fixed inset-x-0 bottom-0 z-[60] grid grid-cols-2 px-safe pb-safe md:hidden">
      <a href={telLink(siteConfig.phones.sales.primary)} onClick={trackCallClick} data-gtm="call_now" className="flex min-h-14 items-center justify-center gap-2 border-r border-water-deep/10 px-2 py-3 text-sm font-bold text-water-deep active:bg-white/40">
