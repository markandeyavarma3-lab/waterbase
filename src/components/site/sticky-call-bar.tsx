...
export function StickyCallBar() {
  return (
    <div className="fixed inset-x-0 bottom-0 z-[60] grid grid-cols-2 bg-brand-green-deep px-safe pb-safe text-white shadow-[0_-2px_16px_rgba(8,43,26,0.25)] md:hidden">
