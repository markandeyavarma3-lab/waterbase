...
import { trackCallClick, trackWhatsAppFloatClick } from "@/lib/analytics";
import { WhatsAppIcon } from "@/components/icons/whatsapp-icon";

/** Mobile-only sticky bar — Call now + WhatsApp on every public page. */
  ...
  return (
    <div className="sink-panel living-mesh-c fixed inset-x-0 bottom-0 z-[60] grid grid-cols-2 px-safe pb-safe md:hidden">
      ...
      <a
        ...
        className="flex min-h-14 items-center justify-center gap-2 px-2 py-3 text-sm font-bold text-water-deep active:bg-white/40"
      >
