...
export function StickyMobileCTA() {
  return (
    <motion.div
      ...
      className="fixed inset-x-0 bottom-0 z-50 grid grid-cols-2 border-t border-border bg-background/95 pb-safe shadow-[0_-2px_16px_rgba(13,26,18,0.08)] backdrop-blur md:hidden"
    >
