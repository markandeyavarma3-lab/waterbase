      ...
      <section className="relative overflow-hidden bg-brand-green-deeper text-white">
        ...
        <Container className="py-16 md:py-24">
          <div className="grid items-start gap-10 lg:grid-cols-[1fr_420px]">
            ...
            <div>
              <Reveal>
                <span className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-1.5 text-sm font-medium backdrop-blur">Authorized Pipe Dealer · Eluru, AP</span>
              </Reveal>
              <Reveal delay={80}>
                <h1 className="mt-5 max-w-xl font-display text-4xl font-extrabold leading-[1.05] tracking-tight md:text-5xl">HDPE, PVC & Casing Pipes — Bulk Supply in Eluru</h1>
              </Reveal>
              <Reveal delay={160}>
      ...
      <Section tone="brand-deep" className="relative overflow-hidden">
        ...
        <Container>
          <Reveal className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-3 font-display text-3xl font-bold leading-tight tracking-tight text-white md:text-4xl">Call us for pricing and availability</h2>
