      ...
      <section className="relative overflow-hidden bg-brand-green-deep text-white">
        ...
        <Container className="py-16 md:py-24">
          <div className="grid items-start gap-10 lg:grid-cols-[1fr_420px]">
            ...
            <div>
              <Reveal>
                <span className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/[0.07] px-4 py-1.5 text-sm font-medium backdrop-blur-md">APMIP Certified Vendor · West Godavari, AP</span>
              </Reveal>
              <Reveal delay={80}>
